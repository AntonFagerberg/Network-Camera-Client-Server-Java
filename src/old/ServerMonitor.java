...
public class ServerMonitor {
	...
	private final static boolean MOVIE = false, IDLE = true;
	private boolean mode = false, transferMode = IDLE;
	private boolean forced;
	public int INT_MOVIE_FORCED = 4, INT_IDLE_FORCED = 3, INT_MOVIE = 2,
			INT_IDLE = 1;
